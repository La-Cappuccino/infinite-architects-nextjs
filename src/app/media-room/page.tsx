        ...
        <div style={{ maxWidth: "90%", margin: "0 auto", paddingTop: "20px" }}>
          ...
          >
            ...
            <div>
              ...
              >
                <p style={{ margin: "0 0 8px 0" }}>Project Name: Villa Shivnani</p>
                <p style={{ margin: "0 0 8px 0" }}>Location: Dubai Hills UAE</p>
                <p style={{ margin: "0 0 8px 0" }}>Date completed: June 2021</p>
              ...
              <div style={{ display: "flex", gap: "30px" }}>
                ...
                >
                  <span style={{ fontSize: "18px" }}>›</span> VIEW LINK
                </Link>
                <Link
                  href="#"
                  style={{
                ...
                >
                  <span style={{ fontSize: "18px" }}>›</span> VIEW MAGAZINE
                </Link>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <p style={{ margin: "0 0 8px 0" }}>Location: London, UK</p>
                <p style={{ margin: "0 0 20px 0" }}>Client: Sleeper Hotel Magazine</p>
              </div>
