...
export function TeamCard({ 
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative overflow-hidden rounded-2xl glass-card transition-all duration-500 ease-out hover-lift",
          "hover:border-[var(--glass-border-green)]",
        ...
        <div className="relative aspect-[3/4] overflow-hidden">
          ...
          <div 
            className={cn(
              ...
              isHovered && "bg-[var(--glass-dark)]"
            )}
            style={{
              background: isHovered 
                ? `linear-gradient(to top, var(--color-black) 0%, rgba(0, 0, 0, 0.4) 50%, transparent 100%)`
                : `linear-gradient(to top, var(--color-black) 0%, rgba(0, 0, 0, 0.2) 50%, transparent 100%)`
            }}
          />
          ...
          <div className="absolute inset-0 flex flex-col justify-end p-6">
            {/* Name */}
            <h3 className={cn(
              "font-display font-light text-accent mb-2 transition-all duration-300",
              ...
              <div className={cn(
                ...
                {member.social.linkedin && (
                  <a
                    ...
                    className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center text-white/70 hover:text-accent hover:border-[var(--color-green)]/50 transition-all duration-300"
                  >
